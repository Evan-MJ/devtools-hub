const TOOL_CATEGORIES = {
    ...
    'media': ['image-compressor', 'image-resizer', 'image-to-text', 'background-remover', 'screenshot-tool', 'video-to-audio', 'video-compressor', 'audio-to-text', 'audio-cutter', 'image-format-converter'],
